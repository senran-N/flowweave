...
pub use proto::{
    ...
    ConnectionIdGenerator, ConnectionStats, DeclaredBackloggedEpochError, DecryptedInitial, Dir,
    ...
    PathId, PathStats, PathStatus, ServerConfig, SetPathStatusError, Side, StdSystemTime, StreamId,
...
pub use crate::connection::{
    ...
    SendDatagram, SendDatagramError, SendDatagramOnPath, SendDatagramOnPathError,
